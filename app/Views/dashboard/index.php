...
<head>
  ...
  <style>
    ...
    * {
    ...
    .book-card:hover .book-cover-sm {
      box-shadow: 4px 8px 20px rgba(69, 40, 41, 0.25);
    }
  ...
  <div class="main-wrap">
    ...
    <main class="page-content">
      ...
      <?php if (session()->getFlashdata('message')): ?>
        <div class="flash-success" id="flashMessage">✓ <?= esc(session()->getFlashdata('message')) ?></div>
      <?php endif; ?>
